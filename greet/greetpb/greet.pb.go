...
package greetpb // import "greet/greetpb"
...
func (*Greeting) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dedecd9b33ba1555, []int{0}
}
...
func (*GreetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dedecd9b33ba1555, []int{1}
}
...
func (*GreetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dedecd9b33ba1555, []int{2}
}
...
func (*GreetManyTimesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dedecd9b33ba1555, []int{3}
}
...
func (*GreetManyTimesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dedecd9b33ba1555, []int{4}
}
...
func (*LongGreetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dedecd9b33ba1555, []int{5}
}
...
func (*LongGreetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dedecd9b33ba1555, []int{6}
}
...
func (*GreetEveryoneRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dedecd9b33ba1555, []int{7}
}
...
func (*GreetEveryoneResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dedecd9b33ba1555, []int{8}
}
...
func (m *SqrtRootRequest) Reset()         { *m = SqrtRootRequest{} }
func (m *SqrtRootRequest) String() string { return proto.CompactTextString(m) }
func (*SqrtRootRequest) ProtoMessage()    {}
func (*SqrtRootRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dedecd9b33ba1555, []int{9}
}
func (m *SqrtRootRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SqrtRootRequest.Unmarshal(m, b)
}
func (m *SqrtRootRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SqrtRootRequest.Marshal(b, m, deterministic)
}
func (dst *SqrtRootRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SqrtRootRequest.Merge(dst, src)
}
func (m *SqrtRootRequest) XXX_Size() int {
	return xxx_messageInfo_SqrtRootRequest.Size(m)
}
func (m *SqrtRootRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_SqrtRootRequest.DiscardUnknown(m)
}

var xxx_messageInfo_SqrtRootRequest proto.InternalMessageInfo

func (m *SqrtRootRequest) GetNumber() int32 {
	if m != nil {
		return m.Number
	}
	return 0
...
func (m *SqrtRootResponse) Reset()         { *m = SqrtRootResponse{} }
func (m *SqrtRootResponse) String() string { return proto.CompactTextString(m) }
func (*SqrtRootResponse) ProtoMessage()    {}
func (*SqrtRootResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dedecd9b33ba1555, []int{10}
}
func (m *SqrtRootResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SqrtRootResponse.Unmarshal(m, b)
}
func (m *SqrtRootResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SqrtRootResponse.Marshal(b, m, deterministic)
}
func (dst *SqrtRootResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SqrtRootResponse.Merge(dst, src)
}
func (m *SqrtRootResponse) XXX_Size() int {
	return xxx_messageInfo_SqrtRootResponse.Size(m)
}
func (m *SqrtRootResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_SqrtRootResponse.DiscardUnknown(m)
}

var xxx_messageInfo_SqrtRootResponse proto.InternalMessageInfo

func (m *SqrtRootResponse) GetResult() float64 {
	if m != nil {
		return m.Result
	}
	return 0
...
func (*GreetWithDeadLineRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dedecd9b33ba1555, []int{11}
}
...
func (*GreetWithDeadLineResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_dedecd9b33ba1555, []int{12}
}
...
func init() {
	...
	proto.RegisterType((*SqrtRootRequest)(nil), "greet.SqrtRootRequest")
	proto.RegisterType((*SqrtRootResponse)(nil), "greet.SqrtRootResponse")
...
type GreetServiceClient interface {
	...
	SqrtRoot(ctx context.Context, in *SqrtRootRequest, opts ...grpc.CallOption) (*SqrtRootResponse, error)
	// Unary
...
func (c *greetServiceClient) SqrtRoot(ctx context.Context, in *SqrtRootRequest, opts ...grpc.CallOption) (*SqrtRootResponse, error) {
	out := new(SqrtRootResponse)
	err := c.cc.Invoke(ctx, "/greet.GreetService/SqrtRoot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetServiceServer interface {
	...
	SqrtRoot(context.Context, *SqrtRootRequest) (*SqrtRootResponse, error)
	// Unary
...
func _GreetService_SqrtRoot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SqrtRootRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServiceServer).SqrtRoot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetService/SqrtRoot",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).SqrtRoot(ctx, req.(*SqrtRootRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _GreetService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SqrtRoot",
			Handler:    _GreetService_SqrtRoot_Handler,
		},
		{
...
func init() { proto.RegisterFile("greet/greetpb/greet.proto", fileDescriptor_greet_dedecd9b33ba1555) }

var fileDescriptor_greet_dedecd9b33ba1555 = []byte{
	// 422 bytes of a gzipped FileDescriptorProto
	,
}
